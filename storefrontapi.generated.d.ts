...
export type ProductSpotlightItemFragment = Pick<
...
export type ProductSpotlightQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ProductSpotlightQuery = {
  products: {
    nodes: Array<
...
interface GeneratedQueryTypes {
  '#graphql\n  #graphql\n  fragment ProductSpotlightItem on Product {\n    id\n    title\n    handle\n    tags\n    images(first: 1) {\n      edges {\n          node {\n            id\n            url\n            altText\n            width\n            height\n          }\n      }\n    }\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n  }\n  query ProductSpotlight($country: CountryCode, $language: LanguageCode) \n    @inContext(country: $country, language: $language) {\n    products(first: 10, query: "tag:featured", sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n       ...ProductSpotlightItem\n      }\n    }\n  }\n': {
    return: ProductSpotlightQuery;
    variables: ProductSpotlightQueryVariables;
  };
